...
function setup() {
  ...
  Q2=createSprite(displayWidth/2+270,450,50,50)
  Q2.addImage("q1",Q2img)
  Q2.scale=0.3
  Q2.visible=false

   A3=createSprite(displayWidth/2+270,480,50,50)
  A3.addImage("a1",A3img)
  A3.scale=0.3
  A3.visible=false

  Q3=createSprite(displayWidth/2-320,530,50,50)
  Q3.addImage("q3",Q3img)
  Q3.scale=0.3
  Q3.visible=false

  A4=createSprite(displayWidth/2+320,460,50,50)
  A4.addImage("a2",A4img)
  A4.scale=0.3
  A4.visible=false

   A5=createSprite(displayWidth/2-420,560,50,50)
  A5.addImage("a5",A5img)
  A5.scale=0.3
  A5.visible=false

  A6=createSprite(displayWidth/2-320,560,50,50)
  A6.addImage("a5",A6img)
  A6.scale=0.3
  A6.visible=false
 ...
 webofspyder=createSprite(displayWidth/2+100,510,50,50)
...
if(ant.x===97){
  ...
  textSize(40)
  fill("black")
  text ("Gameover",displayWidth/2,displayHeight/2-100)
  text("CONGRATULATIONS",displayWidth/2,displayHeight/2-60)
}
